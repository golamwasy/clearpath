...
import com.clearpath.menu.correlationId
    ...
    route("/venues") {
        ...
        route("/{venueId}/items") {
            post {
                ...
                when (val result = repository.create(venueId, request, call.correlationId)) {
            ...
            route("/{itemId}") {
                put {
                    ...
                    when (val result = repository.update(venueId, itemId, request, call.correlationId)) {
                ...
                delete {
                    ...
                    when (val result = repository.delete(venueId, itemId, version, call.correlationId)) {
